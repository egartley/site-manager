namespace Site_Manager
{
    class HTMLBuilder
    {
        public static string GetRedirectionHTML(string destination)
        {
            ...
            return "<!DOCTYPE html><head><!-- Generated by Site Manager (https://egartley.net/go/manager) --><script type=\"text/javascript\">window.location=\"" + destination + "\"</script></head><body></body></html>";
        }
        ...
        public static string GetNavigationBarHTML(string pageurl)
        {
            ...
            {
                return originalcode; // don't bother continuing, won't be in the nav bar
            }
